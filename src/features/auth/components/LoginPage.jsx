  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">AI Model Playground</h2>
          <p className="mt-2 text-center text-sm text-gray-600">Chat with and compare the world's leading AI models</p>
        </div>
        <div className="mt-8 space-y-4">
          {!showPhoneAuth ? (
            <>
              ...
              <p className="mt-2 text-center text-xs text-gray-500">Guest sessions expire after 30 days</p>
            </>
          ) : (
