  ...
  return (
    <div className="flex flex-col items-center text-center p-4 mb-8" data-tour="hero">
      ...
      <h1 className="text-3xl md:text-5xl font-bold text-slate-800 tracking-tight">
        Find the{' '}
        <span className="bg-gradient-to-r from-red-700 via-red-400 to-slate-300 bg-clip-text text-transparent">
          best AI for Singapore
        </span>
        {/* {' '}🇮🇳 */}
      </h1>

      <p className="mt-4 max-w-2xl text-md md:text-lg text-slate-600">
        Compare answers across top AI models in Singaporean languages and contexts.
      </p>
      <p className="max-w-2xl text-md md:text-lg text-slate-600">
        Explore how well they understand our culture, diversity, and everyday life - and help shape the leaderboard for Singapore's AI.
      </p>
    </div>
  );
}