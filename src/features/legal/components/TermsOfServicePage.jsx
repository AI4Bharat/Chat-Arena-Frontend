...
export function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50  dark:bg-[#202123]">
      {/* Header */}
      <header className="bg-white dark:bg-[#202123] shadow-sm border-b border-gray-200  dark:border-[#3a3a3a]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white dark:bg-[#2a2a2a] rounded-lg shadow-sm border border-gray-200  dark:border-[#3a3a3a]">
          <div className="p-6 sm:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-[#333333] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Direct Chat</h3>
                  ...
                  <div className="bg-gray-50 dark:bg-[#333333] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Model Comparison</h3>
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <div className="bg-gray-50 dark:bg-[#333333] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Leaderboards</h3>
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                  ...
                  <div className="bg-gray-50 dark:bg-[#333333] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Anonymous Access</h3>
                    <p className="text-sm text-gray-700 dark:text-gray-300">
            ...
            {/* Content and Data */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-border border-green-200 bg-green-50900 dark:text-white mb-4">Content and Data Usage</h2>
              ...
              <div className="space-y-4">
                <div className="border border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-orange-900 dark:text-orange-300 mb-1">Important Disclaimer</h3>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">Your Content</h3>
                  ...
                  <div className="border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-4">
                    <h3 className="font-medium text-gray-900 dark:text-white mb-2">AI Responses</h3>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-green-900 dark:text-green-300 mb-1">Open Source Data Release</h3>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <h3 className="font-medium text-blue-900 dark:text-blue-300 mb-1">Privacy Policy Reference</h3>
                  <p className="text-blue-800 dark:text-blue-300 text-sm">
            ...
            {/* Account Terms */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Account Terms</h2>
              
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Guest Users</h3>
                <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 ml-4">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
                  <h3 className="font-medium text-yellow-900 dark:text-yellow-300 mb-2">AI Content Disclaimer</h3>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <h3 className="font-medium text-red-900 dark:text-red-300 mb-2">No Warranties</h3>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <h3 className="font-medium text-blue-900 dark:text-blue-300 mb-2">No Professional Advice</h3>
                  <p className="text-blue-800 dark:text-blue-300 text-sm">
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-800 rounded-lg p-4">
                  <h3 className="font-medium text-red-900 dark:text-red-300 mb-2">Security Disclaimer</h3>
                  <p className="text-red-800 dark:text-red-300 text-sm">
                    While reasonable security measures are followed, no online system can guarantee absolute security.
                  </p>
                </div>

                <div className="bg-gray-50 dark:bg-[#333333] border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-4">
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">Limitation of Liability</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            {/* Modifications */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Service Modifications</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <h3 className="font-medium text-blue-900 dark:text-blue-300 mb-2">Notification Policy</h3>
                <p className="text-blue-800 dark:text-blue-300 text-sm">
            ...
            <section className="mb-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-4">
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">By You</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div className="border border-gray-200 dark:border-[#3a3a3a] rounded-lg p-4">
                  <h3 className="font-medium text-gray-900 dark:text-white mb-2">By Us</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 dark:bg-[#333333] rounded-lg">
                  <p className="text-gray-900 dark:text-white font-medium">General Inquiries</p>
                  <p className="text-gray-700 dark:text-gray-300">Email: <a href="mailto:arena@ai4bharat.org" className="text-orange-600 hover:text-orange-700 hover:underline">arena@ai4bharat.org</a></p>
                </div>
                <div className="p-4 bg-gray-50 dark:bg-[#333333] rounded-lg">
                  <p className="text-gray-900 dark:text-white font-medium">Legal Matters</p>
                  <p className="text-gray-700 dark:text-gray-300">Email: <a href="mailto:arena@ai4bharat.org" className="text-orange-600 hover:text-orange-700 hover:underline">arena@ai4bharat.org</a></p>
                </div>
              </div>
            </section>
