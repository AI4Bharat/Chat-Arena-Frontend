...
const Button = ({ children, onClick, onMouseEnter, className = '', ariaLabel }) => (
  <button
    ...
    className={`
      ...
      bg-white dark:bg-slate-800 border border-gray-300 rounded-full shadow-sm 
      text-gray-700 dark:text-slate-200 
      hover:bg-gray-100 dark:hover:bg-slate-700 dark:bg-slate-700 hover:border-gray-400 hover:shadow-md 
  ...
  return (
    ...
    >
      <div className="relative">
        <div
          className="flex items-center p-1 bg-white dark:bg-slate-800/90 backdrop-blur border border-gray-200 dark:border-slate-700/80 rounded-full shadow-md"
