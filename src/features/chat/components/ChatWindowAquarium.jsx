...
import { MessageInput } from './MessageInputAquarium';
import { CompareView } from './CompareView';
import { ExpandedMessageView } from './ExpandedMessageView';
import { NewChatLanding } from './NewChatLandingAquarium';
import { useState, useMemo } from 'react';
import { useStreamingMessage } from '../hooks/useStreamingMessage';
import { toast } from 'react-hot-toast';

import { ServiceNavigationTile } from '../../../shared/components/ServiceNavigationTileAquarium';

export function ChatWindowAquarium({ isSidebarOpen = true }) {
