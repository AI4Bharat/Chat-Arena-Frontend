...
import { nowIST } from '../../tts/utils/dateUtils';
...
const EVALUATION_PARAMETERS = [
  {
    key: 'correctness',
    label: 'Correctness',
    description: 'Is the response factually accurate and free of errors?'
  },
  {
    key: 'instruction_following',
    label: 'Instruction Following',
    description: 'Did the model follow all instructions, constraints, and guidelines?'
  },
  {
    key: 'completeness',
    label: 'Completeness',
    description: 'Does the response address all aspects of the prompt?'
  },
  {
    key: 'clarity',
    label: 'Clarity',
    description: 'Is the response clear, structured, and easy to understand?'
  },
  {
    key: 'language_quality',
    label: 'Language Quality',
    description: 'Grammar, spelling, and overall naturalness of the language.'
  }
];
...
const ChatDetailedFeedback = ({
  mode = 'compare', // 'direct' | 'compare' | 'random'
  onSubmit,
  isSubmitting = false,
  ...
  const handleSubmit = async () => {
    try {
      ...
      await onSubmit(feedbackData, selectionTimestamps);
          ...
          >
            <div className="mt-3 space-y-4 px-3 py-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-sm text-gray-600 mb-4">
                {isDirect
                  ? 'Help us improve by rating the response quality on these parameters:'
              ...
              <div className="space-y-2 mt-6">
                ...
                <textarea
                  ...
                  placeholder="Share any additional thoughts about the response quality..."
...
export default ChatDetailedFeedback;
