...
import { ChatSidebar } from './ChatSidebarAquarium';
import { ChatWindowAquarium } from './ChatWindowAquarium';
...
export function ChatLayoutAquarium() {
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {isLeaderboardRoute ? <LeaderboardContent /> : <ChatWindowAquarium isSidebarOpen={isSidebarOpen} />}
        </div>
