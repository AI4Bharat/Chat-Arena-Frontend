    ...
    <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-slate-900">
      <div className="text-center max-w-2xl">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto">
          <div className="text-center p-4 bg-white rounded-lg border border-gray-200 dark:border-slate-700">
            <Zap className="mx-auto text-blue-600 mb-2" size={24} />
            <h3 className="font-medium text-gray-900">Direct</h3>
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Chat with a single model</p>
          </div>
          
          <div className="text-center p-4 bg-white rounded-lg border border-gray-200 dark:border-slate-700">
            <GitCompare className="mx-auto text-green-600 mb-2" size={24} />
            <h3 className="font-medium text-gray-900">Compare</h3>
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Compare two models side-by-side</p>
          </div>
          
          <div className="text-center p-4 bg-white rounded-lg border border-gray-200 dark:border-slate-700">
            <Shuffle className="mx-auto text-purple-600 mb-2" size={24} />
            <h3 className="font-medium text-gray-900">Random</h3>
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Blind test with random models</p>
          </div>
        </div>
