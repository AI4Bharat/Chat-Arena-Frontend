      ...
      <div className={`w-full px-2 sm:px-4 ${isCentered ? 'pb-0' : 'pb-2 sm:pb-4'} bg-transparent`}>
        ...
        >
            ...
            <GoogleTransliterate
              ...
              onChange={(e) => {}} // Empty onChange handler required by GoogleTransliterate
              ...
              renderComponent={(props) => (
                <TextareaAutosize
                  ref={textareaRef}
                  placeholder={isCentered ? 'Ask anything in your language...' : 'Ask follow-up...'}
                  maxRows={isCentered ? 8 : 4}
                  onHeightChange={(height) => dispatch(setMessageInputHeight(height))}
                  className="w-full px-3 sm:px-4 pt-3 sm:pt-4 bg-transparent border-none focus:ring-0 focus:outline-none resize-none text-gray-800 placeholder:text-gray-500 transition-colors duration-300 text-sm sm:text-base [-webkit-scrollbar]:w-1.5 [-webkit-scrollbar-track]:bg-transparent [-webkit-scrollbar-thumb]:rounded-full [-webkit-scrollbar-thumb]:bg-gray-300 hover:[-webkit-scrollbar-thumb]:bg-gray-400"
                  {...props}
                />
              )}
            />
                ...
                {isTranslateEnabled && (
                  <div className="flex items-center" data-tour="language-selector">
                    ...
                    <LanguageSelector
                      ...
                      onChange={(e) => dispatch(setSelectedLanguage(e.value))}
                    />
                  </div>
                )}
              </div>
