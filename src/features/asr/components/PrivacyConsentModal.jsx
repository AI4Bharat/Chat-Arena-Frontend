  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 transition-all duration-300 ease-out ${
        isVisible
          ? 'bg-black/60 backdrop-blur-sm bg-opacity-50 backdrop-blur-sm'
    ...
    >
      <div
        ...
        className={`bg-white dark:bg-[#2a2a2a] rounded-t-2xl sm:rounded-xl shadow-2xl max-w-md w-full border border-gray-200 dark:border-[#3a3a3a] transition-all duration-300 ease-out transform ${isVisible ? 'translate-y-0 opacity-100 sm:scale-100' : 'translate-y-full opacity-0 sm:scale-95 sm:translate-y-4'}`}
      >
        <div className="flex items-center justify-between gap-4 p-5 border-b border-gray-200 dark:border-[#3a3a3a]">
          ...
          <button
            ...
            className="p-1.5 rounded-full text-gray-400 dark:text-[#ececec] hover:text-gray-700 dark:hover:text-[#ececec] hover:bg-gray-100 dark:hover:bg-[#3a3a3a] transition-colors"
          >
            <X size={20} />
          </button>
        </div>
