      ...
      >
        <div className="flex-shrink-0">
          ...
          <div className="p-2">
            ...
            <div className="relative group" data-tour="asr-leaderboard-link" onMouseEnter={() => setIsLeaderboardDropdownOpen(true)} onMouseLeave={() => setIsLeaderboardDropdownOpen(false)}>
