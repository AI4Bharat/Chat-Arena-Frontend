    ...
    <>
      <div className={`w-full px-2 sm:px-4 ${isCentered ? 'pb-0' : 'pb-2 sm:pb-4'} bg-transparent`}>
        <div className={`relative ${formMaxWidth}`}>
          ...
          <div className="relative flex items-center bg-white border-2 border-blue-500 rounded-xl shadow-sm w-full h-[60px] transition-all" data-tour="asr-message-input">
              ...
              {recordingState === 'review' && (
                <div className="w-full flex items-center gap-3 animate-in fade-in duration-300">
                  <button
                    ...
                    className="flex-shrink-0 p-1.5 sm:p-2 text-gray-500 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-colors"
                  >
              ...
              {recordingState === 'idle' && (
                <>
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-2 text-gray-500 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-colors"
