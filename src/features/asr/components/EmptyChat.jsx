  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-gray-50">
      <div className="text-center max-w-2xl">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mb-2">Welcome to AI Model Playground</h2>
        <p className="text-gray-600 mb-8">Start a new conversation by selecting a mode and choosing your models</p>
        ...
        <p className="text-sm text-gray-500 mt-8">Select a mode from the dropdown above to get started</p>
      </div>
    </div>
  );
}
